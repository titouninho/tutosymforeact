...
class Invoice
{
    ...
    #[Groups(["invoices_read","customers_read"])]
    #[Assert\NotBlank(message:"Veuillez rentrer le montant de la facture")]
    #[Assert\Type(type: "numeric", message: "Le montant de la facture doit être numérique")]
    private $amount;

    #[ORM\Column(type: 'datetime')]
    #[Groups(["invoices_read","customers_read"])]
    #[Assert\NotBlank(message:"Veuillez rentrer la date d'envoi")]
    private $sentAt;

    #[ORM\Column(type: 'string', length: 255)]
    #[Groups(["invoices_read","customers_read"])]
    #[Assert\NotBlank(message:"Veuillez rentrer le status")]
